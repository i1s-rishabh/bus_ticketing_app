...
const { addBus, searchBuses } = require("../controllers/Buses");
...
const bussesTests = () =>
  describe("Test suite Buses.js file", () => {
    describe("Test suite for create a new bus or update the bus", () => {
      ...
      it("It should retrun status 404, as there is no such staff exists", async () => {
        let req = {
          ...mockRequest,
        };
      ...
      it("It should retrun status 404, as there is no such driver exists", async () => {
        let req = {
          ...mockRequest,
        };

        req.body.driver = 1111111111;
        const res = mockResponse();
        await addBus(req, res);
...
module.exports = { bussesTests, searchBuses };
